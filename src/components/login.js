                        ...
                        <div className="col-md-6">
                            ...
                            <form name="loginForm" onSubmit = {this.submitLoginData}>
                                <div className="login-card-body">
                                    ...
                                    <a href="/signup"><button type="button" className="btn btn-rounded btn-block mt-2">Create an Account</button></a>
                                    <p className="forget-password mt-2">Forget Password ?</p>
                                </div>
                            </form>
                        </div>
                        <div className="col-md-6 m-8">
                            <a href="/signup"><button type="button" className="btn btn-block btn-rounded btn-outline-primary mb-2"><i className="fa fa-envelope"> Sign in with Email</i></button></a>
                            <GoogleLogin 
                                ...
                                render = { renderProps =>(
                                    <button type="button" 
                                        ...
                                        <i className="fa fa-google"> Sign in with Gmail</i>
                                    </button>
                                )}
